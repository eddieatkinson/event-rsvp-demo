              ...
              {!hasEvent ? (
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <input
                      type="date"
                      className="mt-1 w-full max-w-full rounded-lg border border-slate-700 bg-slate-900/70 px-3 py-2 text-sm text-slate-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                      value={date}
